...
# 4. finds employees whose last names end with 
# the string 'son':
...
# end with m, and contain any single character 
# between e.g., Tom , Tim T%m
...
# California, USA, and have the credit 
...
# 9. select orders from givin order number 
# (10165,10287,10310) ;

select * from orders where orderNumber in (10165,10287,10310);
select * from orders where orderNumber = 10287;
select * from orders where orderNumber = 10310;
...
# 10. find products whose buy prices us 
# between  90 and 100:
...
WHERE
 ...
 # 11. find top five customers who have 
 # the highest credit:
...
# 12.  find customers who do not have a sales 
# representative
